...
TRAIN_DATA_PATH = "E:/programming/Grad_cam/data/TCGA_train.csv"
subfolder_train_path = "E:/programming/Grad_cam/data/embedding_2d/train"
cross_validation_path = "E:/programming/Grad_cam/data/crossValidation"


def load_data():
    data = np.genfromtxt("E:/programming/Grad_cam/data/TCGA_train.csv", dtype=np.float32, delimiter=",")
    X = data[:, :20531].shape
    Y = data[:, 20531].shape
